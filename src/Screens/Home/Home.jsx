...
function Home() {
  ...
  function article2() {
    window.open("https://www.headspace.com/mindfulness/mindful-cooking", "_blank")
  }

  function article3() {
    window.open("https://www.youtube.com/watch?v=sG7DBA-mgFY&ab_channel=Headspace", "_blank")
  }
  ...
  return (
    ...
    <div className="photo-gallery">
      <div className="photo-gallery1" onClick={() => article1()}>
        ...
        <p>Mindful eating places awareness on the menu, whenever and wherever we eat. As well as making us watchful about what we eat, it aims to transform our relationship with food by focusing on the how and why of eating, encouraging a more holistic point of view. Ultimately, this means we have a better chance of understanding what foods nourish us and what foods help us stay healthy while also encouraging a deeper appreciation of every meal, every mouthful, and every ingredient <span> .  .  .</span></p>
      </div>
      ...
      <div className="photo-gallery2" onClick={() => article2()}>
        ...
        <p>Cooking. For many, it can sound like a chore, especially for parents who are always rustling up some dish for breakfast, lunch, and dinner. But even if you love cooking, where is your mind while preparing the ingredients? Or when stirring the soup or sauce?
        Cooking doesn’t have to be a rushed experience, or something we do on auto-pilot, distracted by thoughts, feelings, and inner-dialogue. In fact, of all the tasks we do in our daily lives, cooking offers a wonderful opportunity for us to train the mind to be present<span> .  .  .</span></p>
      </div>
